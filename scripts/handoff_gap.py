...
# is the always-on nag this replaces. `site/data/` is out for the same reason
# from the other end: the nightly pipeline rewrites it on every run, so counting
# it would fire the message every day over work no human did.
SUBSTANTIVE = ("pipeline", "tests", "tools", "scripts", ".github",
               "site/js", "site/css", "site/index.html")
