...
SCAN_DIRS = ("pipeline", "scripts", "tools", "docs", ".github")
SCAN_FILES = ("TODO.md", "CLAUDE.md", "README.md", "CONTRIBUTING.md")
...
EXCLUDE_PARTS = (
    # `site/` is GENERATED output (CLAUDE.md: never hand-edit it) -- a citation
    # there is the generator's to fix, not a live pointer anyone maintains.
    "node_modules", "site/", "_site", ".venv", ".git", "session-summary",
